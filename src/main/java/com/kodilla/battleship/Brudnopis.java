...
public class Brudnopis extends Application {
    ...
    class MessageBoard extends Pane {
        ...
        Label post(String quote, Color color) {
            ...
            label.setStyle("-fx-background-radius: 5; -fx-background-color: linear-gradient(to bottom, " + bgColor + ", derive(" + bgColor + ", 20%)); -fx-text-fill: ladder(" + bgColor +", lavender 49%, #191970 50%); -fx-font: 18px 'Segoe Script'; -fx-padding:10;");
